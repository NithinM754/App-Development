...
import l1 from '../Assets/system-outline-41-home.gif';
import Dashboard from '../Assets/system-outline-10-analytics (2).gif';
import Attendance from '../Assets/system-outline-14-article (2).gif';
import Marks from '../Assets/system-outline-17-assignment (2).gif';
import Subjects from '../Assets/system-outline-19-book (2).gif';
import Fees from '../Assets/system-outline-38-credit-card.gif';
import l6 from '../Assets/system-outline-56-warning.gif';
import l7 from '../Assets/system-outline-8-account.gif';
