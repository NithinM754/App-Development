...
import l1 from '../Assets/css/system-outline-41-home.gif';
import Dashboard from '../Assets/css/system-outline-10-analytics (2).gif';
...
import l6 from '../Assets/css/system-outline-56-warning.gif';
import l7 from '../Assets/css/system-outline-8-account.gif';
...
//   return (
//     <Container>
//       <Button1 clicked={click} onClick={() => handleClick()}>Click</Button1>
//       <SidebarContainer>
//         <Logo>
//           <img src={l1} alt="logo" />
//         </Logo>
